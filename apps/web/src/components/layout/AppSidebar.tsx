...
const groups = [
  ['OVERVIEW', true, [['Dashboard', '/dashboard', '⌂']]],
  ...
  ['REPORTING', true, [['Issues', '/issues', '◈'], ['Scan History', '/scans', '◷'], ['Reports', '/reports', '▤']]],
...
export function AppSidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const [expanded, setExpanded] = useState<Record<string, boolean>>({ OVERVIEW: true, 'QA CHECKS': true, REPORTING: true });
