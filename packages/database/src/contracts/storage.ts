...
export interface IssueRepository {
  ...
  findByProject(ownerId: string, projectId: string, options?: { severity?: string; status?: IssueStatus; module?: string; detectorId?: string; scanId?: string; pageUrl?: string; limit?: number; cursor?: string }): Promise<{ issues: Issue[]; nextCursor?: string }>;
